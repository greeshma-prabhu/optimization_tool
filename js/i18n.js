...
const translations = {
    en: {
        ...
        cartLoading: {
            ...
            showAlternatives: 'Show Alternative Assignments',
            hideAlternatives: 'Hide Alternatives',
            currentAssignment: 'Current Assignment',
            currentDesc: 'Truck 1: Route 1 + Route 3, Truck 2: Route 2',
            alternative1: 'Alternative: Route 3 on Truck 2',
            alt1Desc: 'Truck 1: Route 1 only, Truck 2: Route 2 + Route 3',
            recommended: 'Recommended',
            extraCost: 'extra cost',
            loadingSequence: 'Loading Sequence',
            loadingSequenceHelp: 'How to Load:',
            loadingSequenceExplanation: 'Why? So when unloading, first delivery is on top and easy to access!',
            more: 'more',
            hideFullList: 'Hide Full List',
            totalCarts: 'carts',
            perTruck: 'per truck',
            fitsInOneTruck: 'Fits in one truck',
            cartsOverflow: 'carts overflow - consider multiple trucks',
            forThisRoute: 'for this route',
            truckTotal: 'Truck total',
            onTruck: 'on truck',
            routesOnTruck: 'Routes on this truck',
            selectTruck: 'Select Truck:',
            selectTruckOption: '-- Select Truck --',
            selectTruckFirst: 'Please select a truck for this route',
            neighborTruck: 'Neighbor\'s Truck',
            externalTruck: 'External Truck',
            truckUnavailable: 'This truck combination is unavailable due to time conflict with another route.',
            usingMultipleTrucks: 'Using {0} trucks ({1} carts each)',
            truckAlreadyAdded: 'This truck is already assigned to this route.',
            stillOverflow: 'Still {0} carts overflow',
            addMoreTrucks: 'Add more trucks to handle overflow:'
        },
        // Carts
        carts: {
        ...
        trucks: {
            ...
            goToCartOptimization: 'Go to Cart Optimization to assign routes',
            goToCartOptimizationTitle: 'Go to Cart Optimization to Run Optimization',
            goToCartOptimizationButton: 'Go to Cart Optimization',
            optimizationWorkflow: '1. Go to Cart Optimization page\n2. Click "Optimize Cart Loading" button\n3. Select trucks for each route\n4. Return here to see the visualization',
            sharedWithOtherTrucks: 'Shared with other trucks'
        },
        // Costs
        costs: {
            title: 'Cost Analysis',
    ...
    nl: {
        ...
        cartLoading: {
            ...
            routeTimeline: 'Route Tijdlijn',
            showAlternatives: 'Toon Alternatieve Toewijzingen',
            hideAlternatives: 'Verberg Alternatieven',
            currentAssignment: 'Huidige Toewijzing',
            currentDesc: 'Vrachtwagen 1: Route 1 + Route 3, Vrachtwagen 2: Route 2',
            alternative1: 'Alternatief: Route 3 op Vrachtwagen 2',
            alt1Desc: 'Vrachtwagen 1: Alleen Route 1, Vrachtwagen 2: Route 2 + Route 3',
            recommended: 'Aanbevolen',
            extraCost: 'extra kosten',
            loadingSequence: 'Laad Volgorde',
            loadingSequenceHelp: 'Hoe te laden:',
            loadingSequenceExplanation: 'Waarom? Zodat bij het lossen de eerste levering bovenop ligt en gemakkelijk toegankelijk is!',
            more: 'meer',
            hideFullList: 'Verberg Volledige Lijst',
            totalCarts: 'karren',
            perTruck: 'per vrachtwagen',
            fitsInOneTruck: 'Past in één vrachtwagen',
            cartsOverflow: 'karren overflow - overweeg meerdere vrachtwagens',
            forThisRoute: 'voor deze route',
            truckTotal: 'Vrachtwagen totaal',
            onTruck: 'op vrachtwagen',
            routesOnTruck: 'Routes op deze vrachtwagen',
            selectTruck: 'Selecteer Vrachtwagen:',
            selectTruckOption: '-- Selecteer Vrachtwagen --',
            selectTruckFirst: 'Selecteer eerst een vrachtwagen voor deze route',
            neighborTruck: 'Buurman\'s Vrachtwagen',
            externalTruck: 'Externe Vrachtwagen',
            truckUnavailable: 'Deze vrachtwagen combinatie is niet beschikbaar vanwege een tijdconflict met een andere route.',
            usingMultipleTrucks: 'Gebruik {0} vrachtwagens ({1} karren elk)',
            truckAlreadyAdded: 'Deze vrachtwagen is al toegewezen aan deze route.',
            stillOverflow: 'Nog steeds {0} karren overflow',
            addMoreTrucks: 'Voeg meer vrachtwagens toe om overflow te verwerken:'
        },
        // Carts
        carts: {
        ...
        trucks: {
            ...
            goToCartOptimization: 'Ga naar Cart Optimization om routes toe te wijzen',
            goToCartOptimizationTitle: 'Ga naar Cart Optimization om Optimalisatie uit te voeren',
            goToCartOptimizationButton: 'Ga naar Cart Optimization',
            optimizationWorkflow: '1. Ga naar Cart Optimization pagina\n2. Klik op "Optimize Cart Loading" knop\n3. Selecteer vrachtwagens voor elke route\n4. Kom hier terug om de visualisatie te zien',
            sharedWithOtherTrucks: 'Gedeeld met andere vrachtwagens'
        },
        // Costs
        costs: {
